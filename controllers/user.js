...
exports.getAccount = (req, res) => {
      ...
      if(req.user.secret) {
        var qrData = sprintf('otpauth://totp/%s?secret=%s', 'Stim Wallet: '+req.user.email, key);
...
exports.postReset = (req, res, next) => {
  ...
  const sendResetPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'no-reply@stimco.in',
      subject: 'Your Stim Web Wallet password has been changed',
...
exports.postForgot = (req, res, next) => {
  ...
  const sendForgotPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: 'no-reply@stimco.in',
      subject: 'Reset your Stim Web Wallet password',
